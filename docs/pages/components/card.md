...
import SlCard from '@decked/decked-design-system/dist/react/card';
import SlRating from '@decked/decked-design-system/dist/react/rating';
...
```jsx:react
import SlCard from '@decked/decked-design-system/dist/react/card';
import SlIconButton from '@decked/decked-design-system/dist/react/icon-button';
