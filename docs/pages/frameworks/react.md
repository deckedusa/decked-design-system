...
:::tip
If you'd rather not use the CDN for assets, you can create a [build task](https://webpack.js.org/plugins/copy-webpack-plugin/) that copies `node_modules/@decked/decked-design-system/%NPMDIR%/assets` into your app's `public` directory. Then you can point the base path to that folder instead.
:::
...
```jsx
import SlButton from '@decked/decked-design-system/%NPMDIR%/react/button/index.js';
...
```jsx
import { SlButton } from '@decked/decked-design-system/%NPMDIR%/react';
```
...
import SlInput from '@decked/decked-design-system/%NPMDIR%/react/input/index.js';
...
import { useState } from 'react';
import SlInput from '@decked/decked-design-system/%NPMDIR%/react/input/index.js';
import type SlInputElement from '@decked/decked-design-system/%NPMDIR%/components/input/input.js';
...
import SlInput, { type SlInputEvent } from '@decked/decked-design-system/%NPMDIR%/react/input/index.js';
import type SlInputElement from '@decked/decked-design-system/%NPMDIR%/components/input/input.js';
