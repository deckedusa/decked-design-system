...
- If you're using the CDN, [import them from the CDN](https://www.jsdelivr.com/package/npm/@decked/decked-design-system?path=%CDNDIR%%2Ftranslations)
- If you're using a bundler, import them from `@decked/decked-design-system/%NPMDIR%/translations/[lang].js`
...
```js
import { registerTranslation } from '@decked/decked-design-system/dist/utilities/localize';
import type { Translation } from '@decked/decked-design-system/dist/utilities/localize';
