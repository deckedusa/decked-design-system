...
```css
@import '/node_modules/@decked/decked-design-system/dist/themes/light.css';
```
...
```js
import '@decked/decked-design-system/dist/components/button/button.js';
import '@decked/decked-design-system/dist/components/icon/icon.js';
import '@decked/decked-design-system/dist/components/dialog/dialog.js';
```
...
```sh
cp -aR node_modules/@decked/decked-design-system/dist/assets/ ./public/assets
```
